...
class NavBackData {
    constructor(nHousId, pPId, nLayerId, nLayerName = null) {
        this.HousId = 0;
        this.PId = null;
        this.LayerId = 0;
        this.LayerName = null;
...
NNavigation.ng_nActiveLayerPath = 0;
...
var GLOBAL = {
    ...
    Action: {
        ...
        pHideCursor: null,
        pStationListFeedback: null,
        pGetAnimateType: null,
        pPathNotFound: null,
    }
};
var SVE_H5_URL = null;
...
$(function () {
    ...
    $("#autostep").click(function () {
        ...
        let type = $(".search-path .path").index($(".search-path .active")), startid = $(".start_input input").attr("roomid"), endid = $(".end_input input").attr("roomid"), event = null;
        if ($(".start_input input").val() == "我的位置") {
            startid = PLocation;
            event = "autostep";
        }
...
$(document).on("touchstart", "#self-part-slide ul li", function () {
    if (($(".mash").show(),
        ...
        var e = $(this).attr("dataid"), t = $(this), a = "", i = !1;
...
$(document).on("touchstart", "#page-self-service map area", function (e) {
    e.preventDefault();
    window.history.replaceState({
        title: "自助导诊"
...
$(document).on("click", ".reversal", function () {
    var e = $(".person-model img").attr("src"), t = $(".person-model img")
        .attr("src")
        .split("/"), a = t[t.length - 1], i = (e.substr(0, e.length - a.length), "");
    switch (a) {
        case "male_face.jpg":
            i +=
    ...
    function ShowFilterList(e, t) {
        ...
        $(".search-list .search-info").each(function () {
            $(this).bind("click", function () {
                ...
                if (lit.length > 1) {
                    var FbuildName = lit[0], FfloorName = lit[1];
                    let reg = /-[0-9]|[0-9]/;
...
$(function () {
    ...
    function renderHospitalRoom(data) {
        ...
        var html = "", buildname = "", floor = "", roomName = "", roomId = "";
